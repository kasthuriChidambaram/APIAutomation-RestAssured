...
public class GetCountryPopulationStepdefs {
    ...
    @Then("the system responds with {string} as nation")
    public void theSystemRespondsWithNationAsUnitedStates(String nation) {
        ...
        Assert.assertEquals(true, dataList.stream().allMatch(str -> str.equals(nation)));
    }
    ...
    public void theSystemRespondsWithNationsPopulationForTheYearsAs() {
        List<String> expectedYearList = new ArrayList<>(Arrays.asList("2022","2021","2020", "2019", "2018", "2017", "2016", "2015", "2014", "2013"));
